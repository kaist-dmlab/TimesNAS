# TimesNAS
This is the official implementation of the ***Time Series-Aware Zero-Shot Neural Architecture Search for General Time-Series Analysis*** paper _Under Review_ to Neural Networks
<!-- [[Paper]()]] -->
